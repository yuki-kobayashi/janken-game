...
- **アニメーションが乏しい**：現状、ゲームとしての臨場感や操作の気持ちよさを高めるアニメーションが少ないため、UX向上の余地があると感じています。今後はフロントエンドスキルをさらに磨き、プレイヤーが勝利した際の「WIN」エフェクトや、じゃんけんの手の動きをCSSやJavaScriptで動かす演出など、よりゲームらしい体験ができるよう改善していきたいです。
